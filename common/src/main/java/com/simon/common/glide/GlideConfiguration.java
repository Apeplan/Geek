package com.simon.common.glide;
...
public class GlideConfiguration implements GlideModule {
    ...
    private static int sCacheSize = 1024 * 1024 * 100;
...
//        builder.setDecodeFormat(DecodeFormat.PREFER_ARGB_8888);
        ...
        int cacheSize100MegaBytes = sCacheSize;
...
//        builder.setDiskCache(new DiskLruCacheFactory(downloadDirectoryPath, "patientCache",
// cacheSize100MegaBytes));
        /**磁盘缓存路径，四者根据情况任选一**/
    }
