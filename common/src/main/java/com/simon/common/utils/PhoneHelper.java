...
public class PhoneHelper {
     ...
     * @param phoneNumber 需要呼叫的手机号码
     */
    public static void openDial(Context mContext, String phoneNumber) {
        Uri uri = Uri.parse("tel:" + phoneNumber);
     ...
     */
    public static void sendMessage(final Context mContext, final String strPhone, final String
            strMsgContext) {
        ...
        mContext.registerReceiver(new BroadcastReceiver() {
                                      @Override
                                      public void onReceive(Context _context, Intent _intent) {
                                          Toast.makeText(mContext, strPhone + "已经成功接收", Toast
                                                  .LENGTH_SHORT).show();
                                      }
                                  },
     ...
     * @param strMsgContext 短信内容
     */
    public static void openSMS(Context mContext, String strPhone, String strMsgContext) {
     ...
     */
    public static void openContactsList(Activity mContext, int requestCode) {
            ...
            if (phoneNum > 0) {
                ...
                if (phones.moveToFirst()) {
                    ...
                    for (; !phones.isAfterLast(); phones.moveToNext()) {
                        int index = phones.getColumnIndex(ContactsContract.CommonDataKinds.Phone
                                .NUMBER);
