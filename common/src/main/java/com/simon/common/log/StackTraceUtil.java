...
/**
 * describe: Utility related with stack trace.
 *
 * @author Simon Han
 * @date 2016.11.17
...
public class StackTraceUtil {
    ...
    static {
        String xlogClassName = LLog.class.getName();
     ...
     * @param maxDepth   the max depth of real stack trace that will be cropped, 0 means no
     *                   limitation
