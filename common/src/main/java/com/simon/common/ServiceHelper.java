...
public class ServiceHelper {
    ...
    public <I> I creator(String baseUrl, Class<I> clazz, long timeOut, Headers headers) {
        ...
        try {
            ...
            SSLSocketFactory sslSocketFactory = new Tls12SocketFactory(sslcontext
                    .getSocketFactory());
            HttpsUtil.UnSafeTrustManager unSafeTrustManager = new HttpsUtil.UnSafeTrustManager();
            okHttpClient.sslSocketFactory(sslSocketFactory, unSafeTrustManager);
