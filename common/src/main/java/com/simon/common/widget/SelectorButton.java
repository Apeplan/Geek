package com.simon.common.widget;
...
public class SelectorButton extends AppCompatButton {
    ...
    private void setup(AttributeSet attrs) {
        ...
        int mDefaultNormalTextColor = mTextColorStateList.getColorForState(states[2],
                getCurrentTextColor());
        int mDefaultPressedTextColor = mTextColorStateList.getColorForState(states[0],
                getCurrentTextColor());
        int mDefaultUnableTextColor = mTextColorStateList.getColorForState(states[3],
                getCurrentTextColor());
        mNormalTextColor = a.getColor(R.styleable.SelectorButton_normalTextColor,
                mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.SelectorButton_pressedTextColor,
                mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.SelectorButton_unableTextColor,
                mDefaultUnableTextColor);
        setTextColor();
        ...
        mNormalBackgroundColor = a.getColor(R.styleable.SelectorButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.SelectorButton_pressedBackgroundColor, 0);
        ...
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.SelectorButton_pressedStrokeWidth,
                0);
    ...
    public void setStateStrokeColor(@ColorInt int normal, @ColorInt int pressed, @ColorInt int
            unable) {
    ...
    public void setStateBackgroundColor(@ColorInt int normal, @ColorInt int pressed, @ColorInt
            int unable) {
    ...
    private void setTextColor() {
        int[] colors = new int[]{mPressedTextColor, mPressedTextColor, mNormalTextColor,
                mUnableTextColor};
        mTextColorStateList = new ColorStateList(states, colors);
        setTextColor(mTextColorStateList);
    }

    public void setStateTextColor(@ColorInt int normal, @ColorInt int pressed, @ColorInt int
            unable) {
