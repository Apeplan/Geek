...
public class RecycledViewHolder extends RecyclerView.ViewHolder {
    ...
    public RecycledViewHolder setOnLongClickListener(int viewId, View.OnLongClickListener
            listener) {
        View view = getView(viewId);
    ...
    public RecycledViewHolder setOnItemLongClickListener(int viewId, AdapterView
