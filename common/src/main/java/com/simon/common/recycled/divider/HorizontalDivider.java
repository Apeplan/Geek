package com.simon.common.recycled.divider;
...
/**
 * describe: horizontal item decoration for RecyclerView
 *
 * @author Simon Han
 * @date 2015.09.21
...
public class HorizontalDivider extends Divider {
    ...
    public static class Builder extends Divider.Builder<Builder> {
