...
public class StatusbarUtil {
     ...
     */
    public static void setBgColorLight(Activity activity, @ColorRes int colorLight, @ColorRes int
            colorDeep) {
     ...
     * @param index
     */
    public static void onTabChangeIfNoThrough(Activity activity, List<StatusColorBean>
            colorBeans, View statusBarView, int index) {
     ...
     * @param index
     */
    public static void onTabChangeIfHasThrough(Activity activity, List<StatusColorBean>
            colorBeans, int index) {
    ...
    public static class StatusColorBean {
        ...
        /*public StatusColorBean(int colorRes, boolean isLight, boolean isThrough,int
        colorResBackup) {
        ...
        public StatusColorBean(int colorRes, boolean isLight, boolean isThrough, int
                colorResBackup, View statusBarView) {
            this.colorRes = colorRes;
            this.isLight = isLight;
            this.isThrough = isThrough;
            this.colorResBackup = colorResBackup;
